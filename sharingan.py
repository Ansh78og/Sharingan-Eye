...
pupil_radius = 12
sensitivity = 0.07
bg_img = cv2.imread(r"C:\Users\ansho\Downloads\sharingan\sharingan\shh.jpg")
if bg_img is None:
...
overlay_png = cv2.imread(r"C:\Users\ansho\Downloads\sharingan\sharingan\top.png", cv2.IMREAD_UNCHANGED)
